...
class _CompletionAnimationState extends State<CompletionAnimation>
  ...
  static const _messagesByEmotion = <int, List<String>>{
    ...
    2: ['불안한 마음을 꺼내놓은 것, 용기 있는 일이에요', '마음을 글로 바라봤어요', '오늘의 감정을 기록한 당신, 괜찮아요'],
    3: ['오늘도 나를 기록했어요', '작은 기록을 오늘도 남겼어요', '하루를 천천히 돌아봤어요'],
    4: ['평온한 하루를 잘 담아냈어요', '오늘의 나에게 한 걸음 더 가까이', '기록하는 당신, 충분히 멋져요'],
    5: ['감사한 마음을 기록했어요', '오늘의 감사도 한 줄로 남겼어요', '오늘의 감정을 차분히 남겼어요'],
  };
